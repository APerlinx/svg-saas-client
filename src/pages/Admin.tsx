...
export default function Admin() {
  ...
  // Show access denied for regular logged-in users
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-gray-600 text-base mb-8">
            You don't have permission to access this admin area. Only authorized
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 bg-blue-600 text-white font-medium py-2.5 px-6 rounded-lg transition-all hover:bg-blue-700 shadow-sm"
          >
            <svg
              className="w-4 h-4"
              fill="none"
