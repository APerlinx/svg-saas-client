    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-linear-to-br from-gray-50 to-gray-100 rounded-2xl p-8 flex items-center justify-center min-h-[400px] border-2 border-gray-200">
            <div
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gray-200 text-gray-700 rounded-lg font-medium hover:bg-gray-300 transition-all relative group"
            >
              <svg
                className="w-5 h-5"
                fill="none"
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={handleEdit}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition-all relative group"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <p className="text-xs text-gray-500 text-center">
            ...
            <code className="bg-gray-100 px-1 rounded">img src</code> or CSS
            backgrounds
          </p>
        </div>
      </div>
